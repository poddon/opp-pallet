...
(function () {
  ...
  function answer(choice) {
    ...
    (window.__strip||{textContent:""}).textContent = ok ? "Смешанный контроль по материалу модулей" : "Неверный ответ";
    if (ok) {
